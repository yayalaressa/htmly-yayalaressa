                ...
                <div class="sidebar">
                    ...
                    <div class="card mb-4 bg-light border-0">
                        <div class="card-body popular">
                            <h2 class="card-title border-bottom py-2"><?php echo i18n("Popular_posts");?></h2>
                    ...
                    <?php endif;?>
                  	<div class="card mb-4 bg-light border-0">
                        <div class="card-body archive">
                            <h2 class="card-title border-bottom py-2"><?php echo i18n("Archives");?></h2>
                          	<ul>
                            <?php $data = archive_list(true);
										foreach ($data as $year => $months) {
											...
											echo '<li><a href="' . site_url() . 'archive/' . $year . '-' . $month . '">' . $name . ' ' . $year .'</a> ('.$count.')</li>';
											}
										}
							?>
                          </ul>
